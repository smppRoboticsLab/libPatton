...
%            9/29/0     CCFIT9: ADD INPUT protocolNum & changed data filename struct
%~~~~~~~~~~~~~~~~~~~~~~ Begin Program: ~~~~~~~~~~~~~~~~~~~~~~~~~~

function [CCB,r,aveErr,fracErr]=ccFit9(CCB,maxTime,trialList,fitOrNot,CCwings,protocolNum,verbose,plotIt);
...
[trialHeader,trialData]=  ...
  hdrload(['targ_p' num2str(protocolNum) '.txd']);            % load list of movements 
...
for pertTrial=1:Ntrials                                 % loop for each perturbation trial
  ...
  fname=['p' num2str(protocolNum) '_'               ... % construct perturb filename
      num2str(trialList(pertTrial)) '.dat'];     
