...
function ensembleTrials2(trialList,protocolNum,outName,interval,plotit,verbose,printIt)

% __ SETUP __
fcnName='ensembleTrials2.m';
if ~exist('protocolNum'),  protocolNum=1;end                % if not passed 
