% XPC2DatamanFormat: convert XPC file to the old DOS format (Dataman)
%************** MATLAB "M" fcn ************
% SYNTAX:     procdata(exp_name)
% Inputs :    data_*.txd (file on XPC target hard drive)
% Outputs:    P1*_.dat (file)
% REVISIONS:  INITIATED (Wei), Nov 20, 2003 as transformdata2oldformat
%             12-2006+ (Patton) revised & renamed as XPC2DatamanFormat
%~~~~~~~~~~~~~~~~~~~~~ Begin : ~~~~~~~~~~~~~~~


function XPC2DatamanFormat(exp_name)

%% SETUP
fcnName='XPC2DatamanFormat.m';
fprintf('\n~ %s ~',fcnName)
ndatafile = [exp_name '.dat']; % ndatafile = [pwd '\scrs.dat'];
...
fprintf('\nCreating Dataman format files for individual Trials..');
...
if(strcmp(lower(exp_name),'sfd') & exist('F_358.DAT', 'file'));
